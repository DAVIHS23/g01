...
function drawMigrationsGraph(data, country) {
    ...
    var svg = d3.select("#migrationsGraph")
        .append("svg")
   ...
   svg.append("text")
    ...
    var y = d3.scaleLinear()
        .domain(d3.extent(filteredData, function(d) { return d.migration; })) // Use extent to cover negative values
        .range([height, 0]);
  ...
  var areaGenerator = d3.area()
      ...
      .y0(y(0))
      .y1(function(d) { return y(d.migration); })
